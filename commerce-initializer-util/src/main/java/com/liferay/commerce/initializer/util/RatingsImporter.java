...
public class RatingsImporter {
	...
	public void importRatings(File ratingsFile, ServiceContext serviceContext)
		throws Exception {
	...
	private void _importRating(
		...
		ratingsEntry = _ratingsEntryLocalService.updateRatingsEntry(
			ratingsEntry);
